...
@app.route('/')
def index():
    # Convert alerts dictionary to a list of "message count" format
    alert_list = [f"{key} {value}" for key, value in alerts.items()]
    return render_template('index.html', alerts=alert_list)
